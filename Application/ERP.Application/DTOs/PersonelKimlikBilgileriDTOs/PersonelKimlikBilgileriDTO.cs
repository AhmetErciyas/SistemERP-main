...
namespace ERP.Application.DTOs.PersonelKimlikBilgileriDTOs
{
    public class PersonelKimlikBilgileriDTO
    {
    ...
    public class PersonelKimlikBilgileriEkleDTO
    {
        public int kimlikTurid { get; set; }
        public int? medeniHal { get; set; }
        public bool? cinsiyet { get; set; }
    ...
    public class PersonelKimlikBilgileriGuncelleDTO
    {
